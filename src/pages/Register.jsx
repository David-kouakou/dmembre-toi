    ...
    <div className="pt-32 min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full bg-black text-white py-2 rounded-lg hover:bg-gray-800">S'inscrire</button>
        </form>
        <p className="text-center text-gray-500 mt-4">Déjà un compte ? <Link to="/login" className="text-red-500">Se connecter</Link></p>
      </div>
    </div>
  );
};
